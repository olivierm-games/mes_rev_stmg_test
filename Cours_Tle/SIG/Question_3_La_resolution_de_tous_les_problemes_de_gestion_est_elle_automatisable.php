...
<body>
	...
	<div id="all-container" class="night-mode-element">
		...
		<main class="night-mode-element">
			<h1>Question 3 : La résolution de tous les problèmes de gestion est-elle automatisable ?</h1>
			...
			<section class="h2-container">
				...
				<div class="h3-container">
					...
					<table class="tab_sig">
						<thead>
							<tr>
								<th colspan="3" class="td_centre td_sig td_background_sig">Exemple en PHP</th>
							</tr>
						</thead>
						<tbody>
							<tr>
				...
				<section class="h2-container">
					...
					<div class="h3-container">
						...
						<table class="tab_sig">
							<thead>
								<tr>
									<th colspan="3" class="td_background_sig td_sig td_centre">Structure en PHP</th>
								</tr>
							</thead>
							<tbody>
								<tr>
								...
								<tr>
									...
									<tr>
										<td colspan="2" class="pad_left_indent">{<span class="text_turquoise">echo </span><span class="text_vert">"4x"</span> . <span	class="text_red">$i</span> . <span class="text_vert">"="</span> . (4*<span class="text_red">$i</span>) . <span class="text_vert">"&lt;br />"</span>;}</td>
					...
					<div class="h3-container">
						...
						<section class="h2-container">
							...
							<div class="h3-container">
								<h3>A. Fonctions prédéfinies</h3>
								<p>Les langages de programmation fournissent des fonctions prédéfinies.</p>
								<p><u>Illustrons par des exemples en PHP</u> :</p>
								<table class="tab_sig">
									<thead>
										<tr>
											<th colspan="2" class="td_background_sig td_centre td_sig">Description d'une fonction prédéfinie sans arguments en entrée : time()</th>
										</tr>
									</thead>
									<tbody>
										<tr>
										...
										<tr>
											<td><span class="text_turquoise">echo</span><span class="text_vert"> "Il y a "</span> . <span class="text_turquoise">time</span>()/(<span class="text_orange">365.25</span>*<span class="text_orange">24</span>*<span class="text_orange">60</span>*<span class="text_orange">60</span>) . <span class="text_vert">" années, naissait UNIX."</span>;<span class="text_grey"> /* commentaire : conversion secondes en années */</span></td>
								...
								<table class="tab_sig">
									<thead>
										<tr>
											<th colspan="2" class="td_background_sig td_centre td_sig">Description d'une fonction prédéfinie avec un argument en entrée : date()</th>
										</tr>
									</thead>
									<tbody>
										<tr>
											...
											<tr>
												<td colspan="2">La fonction <span class="text_turquoise">date</span>(<span class="text_grey">'arg'</span>) retourne une date (le premier argument (<span class="text_red">$format</span>), demande un format de date : <a href="https://secure.php.net/manual/fr/function.date.php" class="approf_sig" target="_blank">voir</a> tous les formats).</td>
											</tr>
											<tr>
									...
									<table class="tab_sig">
										<thead>
											<tr>
												<th colspan="2" class="td_background_sig td_centre td_sig">Description d'une fonction prédéfinie avec plusieurs arguments en entrée : round()</th>
											</tr>
										</thead>
										<tbody>
											<tr>
							...
							<div class="h3-container">
								...
								<table class="tab_sig">
									<thead>
										<tr>
											<th class="td_background_sig td_sig td_centre">Syntaxe</th>
											<th class="td_background_sig td_sig td_centre">Exemple</th>
										</tr>
									</thead>
									<tbody>
										<tr>
					...
					<nav>
						...
						<a href="Question_2_Les_evolutions_technologiques_sont_elles_exemptes_de_risques_pour_l_organisation.html" class="button night-mode-element" title="Les évolutions technologiques sont-elles exemptes de risques pour l'organisation ?">Question 2</a>
						<a href="Question_4_Comment_peut_on_produire_de_l_information_a_partir_de_donnees_contenues_dans_une_base.html" class="button night-mode-element" title="Comment peut-on produire de l'information à partir de données contenues dans une base ?">Question 4</a>
					</nav>
